...
#define BITS2BYTES(BITS)           (((BITS)>>3)+(((BITS)&7)?1:0))
#define BYTES2BLOCKS(BYTES)        (((BYTES)>>4)+(((BYTES)&15)?1:0))
#define BITS2BLOCKS(BITS)          BYTES2BLOCKS(BITS2BYTES(BITS))
#define BLOCK_ALIGNED_BYTES(BYTES) (BYTES2BLOCKS(BYTES)<<4)
